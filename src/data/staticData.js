...
// ── DEAL PIPELINE (Deal Stages.docx · received from business team) ──
// Off Plan is now the single canonical deal pipeline. The legacy Resale
// stages (Property Viewed / Offer Made / Offer Accepted / Contract Signed
// & Payment) were retired in May 2026 — every previous Resale deal was
// migrated to the closest Off Plan stage and the type='Resale' branch is
...
// Back-compat shim — kept as a no-op selector so any straggling caller
// still resolves to the Off Plan stages. Safe to remove once all imports
// of stagesForDealType are gone.
export const stagesForDealType = () => DEAL_STAGES_OFFPLAN;

// ── DEALS ──
// Schema (May 2026, Resale retired):
//   type              'OffPlan' (only)
//   stage             one of DEAL_STAGES_OFFPLAN above
//   propertyId        FK to a Listing (l.id) — what unit/property the deal is about
//   attachments       [{ id, name, size, uploadedAt }]
//   reservationDeposit  EGP — deposit at Reservation stage
//   paymentPlan       e.g. "10% down, 5y installments"
...
export const DEALS = [
  ...
  { id: "D-506", type: "OffPlan", lead: "Karim Fouad", owner: "Omar Sherif", team: "Alpha", project: "Madinaty", developer: "Talaat Moustafa", propertyId: "LST-005", stage: "Standard Collection (10%)", value: 5200000, commission: 1.5, reservationDeposit: 100000, paymentPlan: "10% down · 10y installments", collectionPercent: 12, commissionLocked: true, homesAdvanceAvailable: true, revenueRecognised: true, attachments: [{ id:'ATT-004', name:'SPA_Madinaty_APT-C110.pdf', size:'1.1 MB', uploadedAt:'2023-12-20' }, { id:'ATT-005', name:'Commission_Release_TM.pdf', size:'180 KB', uploadedAt:'2024-01-15' }], status: "Closed", created: "2023-12-15" },
  // Converted from legacy Resale pipeline (May 2026) — Off Plan only now.
  // Stage mapping: Property Viewed→Lead Qualified · Offer Made→Reservation ·
  // Offer Accepted→Contract Signed · Contract Signed & Payment→Standard Collection (10%).
  { id: "D-507", type: "OffPlan", lead: "Mona Fawzy",   owner: "Omar Sherif",   team: "Beta",  project: "Mountain View",       developer: "Mountain View", propertyId: "LST-007", stage: "Lead Qualified",   value: 7000000,  commission: 2.0, reservationDeposit: 0,      paymentPlan: "—",                          collectionPercent: 0,  commissionLocked: false, homesAdvanceAvailable: false, revenueRecognised: false, attachments: [], status: "Active", created: "2024-01-18" },
  { id: "D-508", type: "OffPlan", lead: "Layla Ahmed",  owner: "Ahmed Hassan",  team: "Alpha", project: "Sodic West",          developer: "Sodic",         propertyId: "LST-006", stage: "Reservation",      value: 9800000,  commission: 2.5, reservationDeposit: 200000, paymentPlan: "15% down · 6y installments", collectionPercent: 0,  commissionLocked: false, homesAdvanceAvailable: false, revenueRecognised: false, attachments: [{ id:'ATT-006', name:'Offer_Letter.pdf', size:'95 KB', uploadedAt:'2024-01-17' }], status: "Active", created: "2024-01-17" },
  { id: "D-509", type: "OffPlan", lead: "Fatma Tarek",  owner: "Fatma Ibrahim", team: "Alpha", project: "Palm Hills Katameya", developer: "Palm Hills",    propertyId: "LST-008", stage: "Contract Signed",  value: 14500000, commission: 2.0, reservationDeposit: 290000, paymentPlan: "10% down · 8y installments", collectionPercent: 3,  commissionLocked: true,  homesAdvanceAvailable: false, revenueRecognised: false, attachments: [{ id:'ATT-007', name:'MOU_draft.pdf', size:'240 KB', uploadedAt:'2024-01-16' }], status: "Active", created: "2024-01-14" },
  // Lost
  ...
  { id: "D-518", type: "OffPlan", lead: "Khaled Tarek",    leadName: "Khaled Tarek",    owner: "Ahmed Hassan",  team: "Alpha", project: "Mountain View iCity",  developer: "Mountain View",    propertyId: "LST-007", stage: "Standard Collection (10%)",     value: 9400000,  commission: 2.0, reservationDeposit: 200000, paymentPlan: "10% down · 7y installments", collectionPercent: 12, commissionLocked: true, homesAdvanceAvailable: true,  revenueRecognised: true,  attachments: [{ id:'ATT-015', name:'SPA_MV_Approved.pdf', size:'1.1 MB', uploadedAt:'2026-03-01' }, { id:'ATT-016', name:'Commission_Release.pdf', size:'180 KB', uploadedAt:'2026-05-02' }], status: "Closed", created: "2026-02-20" },
  { id: "D-519", type: "OffPlan", lead: "Nour Magdy",      leadName: "Nour Magdy",      owner: "Fatma Ibrahim", team: "Alpha", project: "Sodic West",           developer: "Sodic",            propertyId: "LST-006", stage: "Standard Collection (10%)",     value: 10300000, commission: 2.1, reservationDeposit: 220000, paymentPlan: "15% down · 6y installments", collectionPercent: 14, commissionLocked: true, homesAdvanceAvailable: true,  revenueRecognised: true,  attachments: [{ id:'ATT-017', name:'SPA_Sodic_West.pdf', size:'1.2 MB', uploadedAt:'2026-02-25' }, { id:'ATT-018', name:'Commission_Release_Sodic.pdf', size:'180 KB', uploadedAt:'2026-04-28' }], status: "Closed", created: "2026-02-10" },
  { id: "D-520", type: "OffPlan", lead: "Aya Nasr",        leadName: "Aya Nasr",        owner: "Hana Mahmoud",  team: "Beta",  project: "ZED East",             developer: "Ora",              propertyId: "LST-002", stage: "Lead Qualified",                value: 14800000, commission: 2.5, reservationDeposit: 0,      paymentPlan: "—",                          collectionPercent: 0,  commissionLocked: false, homesAdvanceAvailable: false, revenueRecognised: false, attachments: [], status: "Active",     created: "2026-04-25" },
  { id: "D-521", type: "OffPlan", lead: "Wael Helmy",      leadName: "Wael Helmy",      owner: "Omar Sherif",   team: "Beta",  project: "Cairo Festival City",  developer: "Al-Futtaim",       propertyId: null,      stage: "Lead Qualified",                value: 6500000,  commission: 2.0, reservationDeposit: 0,      paymentPlan: "—",                          collectionPercent: 0,  commissionLocked: false, homesAdvanceAvailable: false, revenueRecognised: false, attachments: [], status: "Active",     created: "2026-04-24" },
  { id: "D-522", type: "OffPlan", lead: "Dina Khalil",     leadName: "Dina Khalil",     owner: "Ahmed Hassan",  team: "Alpha", project: "Mivida",               developer: "Emaar",            propertyId: null,      stage: "Reservation",                   value: 7800000,  commission: 2.2, reservationDeposit: 150000, paymentPlan: "10% down · 8y installments", collectionPercent: 0,  commissionLocked: false, homesAdvanceAvailable: false, revenueRecognised: false, attachments: [{ id:'ATT-019', name:'Offer_Letter_Mivida.pdf', size:'90 KB', uploadedAt:'2026-04-15' }], status: "Active", created: "2026-04-12" },
  { id: "D-523", type: "OffPlan", lead: "Hossam Magdy",    leadName: "Hossam Magdy",    owner: "Fatma Ibrahim", team: "Alpha", project: "Eastown Residences",   developer: "Sodic",            propertyId: null,      stage: "Contract Signed",               value: 12100000, commission: 2.3, reservationDeposit: 240000, paymentPlan: "15% down · 6y installments", collectionPercent: 3,  commissionLocked: true,  homesAdvanceAvailable: false, revenueRecognised: false, attachments: [{ id:'ATT-020', name:'MOU_Eastown.pdf', size:'260 KB', uploadedAt:'2026-05-01' }], status: "Active", created: "2026-05-01" },
  { id: "D-524", type: "OffPlan", lead: "Hassan Magdy",    leadName: "Hassan Magdy",    owner: "Ahmed Hassan",  team: "Alpha", project: "Mivida",               developer: "Emaar",            propertyId: null,      stage: "Lead Qualified",                value: 6800000,  commission: 2.0, reservationDeposit: 0,      paymentPlan: "—",                          collectionPercent: 0,  commissionLocked: false, homesAdvanceAvailable: false, revenueRecognised: false, attachments: [], status: "Active",     created: "2026-05-16" },
  ...
  { id: "D-526", type: "OffPlan", lead: "Salma Adel",      leadName: "Salma Adel",      owner: "Hana Mahmoud",  team: "Beta",  project: "Telal Sokhna",         developer: "Roya",             propertyId: null,      stage: "Lead Qualified",                value: 6200000,  commission: 2.0, reservationDeposit: 0,      paymentPlan: "—",                          collectionPercent: 0,  commissionLocked: false, homesAdvanceAvailable: false, revenueRecognised: false, attachments: [], lostReason: "Customer wanted ready-to-move", status: "Closed Lost", created: "2026-03-08" },
  ...
  // ─── Backfill deals (Wave K-1, May 2026) — every COMM_ENGINE row must
  //     trace back to a real deal record. These 11 entries are the
  //     historical/closed deals that generated the previously orphan
  //     commissions (CE-01..CE-25 minus the ones already linked above).
  //     value × commission% ≈ the commission pool, so finance audits tie out.
  { id: "D-601", type: "OffPlan", lead: "Mostafa Adel",    leadName: "Mostafa Adel",    owner: "Ahmed Hassan",  team: "Alpha", project: "Badya",                developer: "Palm Hills",       propertyId: null,      stage: "Standard Collection (10%)",     value: 6750000,  commission: 2.0, reservationDeposit: 150000, paymentPlan: "10% down · 7y installments", collectionPercent: 12, commissionLocked: true, homesAdvanceAvailable: true,  revenueRecognised: true,  attachments: [{ id:'ATT-022', name:'SPA_Badya_A101.pdf', size:'1.1 MB', uploadedAt:'2026-04-10' }], status: "Closed",      created: "2026-03-20" },
  { id: "D-602", type: "OffPlan", lead: "Hala Magdy",      leadName: "Hala Magdy",      owner: "Fatma Ibrahim", team: "Alpha", project: "Mivida",               developer: "Emaar",            propertyId: null,      stage: "Contract Signed",               value: 9300000,  commission: 2.0, reservationDeposit: 200000, paymentPlan: "10% down · 8y installments", collectionPercent: 4,  commissionLocked: true, homesAdvanceAvailable: false, revenueRecognised: false, attachments: [{ id:'ATT-023', name:'SPA_Mivida_B205.pdf', size:'1.2 MB', uploadedAt:'2026-05-10' }], status: "Active",      created: "2026-05-12" },
  { id: "D-603", type: "OffPlan", lead: "Tareq Saleh",     leadName: "Tareq Saleh",     owner: "Mohamed Ali",   team: "Beta",  project: "Mountain View iCity",  developer: "Mountain View",    propertyId: "LST-007", stage: "Standard Collection (10%)",     value: 5700000,  commission: 2.0, reservationDeposit: 120000, paymentPlan: "10% down · 7y installments", collectionPercent: 14, commissionLocked: true, homesAdvanceAvailable: true,  revenueRecognised: true,  attachments: [{ id:'ATT-024', name:'SPA_MV_C310.pdf', size:'1.1 MB', uploadedAt:'2026-02-28' }], status: "Closed",      created: "2026-02-05" },
  { id: "D-604", type: "OffPlan", lead: "Wafaa Hosny",     leadName: "Wafaa Hosny",     owner: "Dina Samir",    team: "Alpha", project: "Cleopatra New Cairo",  developer: "Cleopatra Group",  propertyId: null,      stage: "Contract Signed",               value: 5800000,  commission: 1.5, reservationDeposit: 120000, paymentPlan: "10% down · 7y installments", collectionPercent: 3,  commissionLocked: true,  homesAdvanceAvailable: false, revenueRecognised: false, attachments: [{ id:'ATT-025', name:'MOU_Cleopatra.pdf', size:'240 KB', uploadedAt:'2026-05-14' }], status: "Active",      created: "2026-05-14" },
  { id: "D-605", type: "OffPlan", lead: "Said Ezzat",      leadName: "Said Ezzat",      owner: "Ahmed Hassan",  team: "Alpha", project: "Open Sky",             developer: "Talaat Moustafa",  propertyId: null,      stage: "Standard Collection (10%)",     value: 11700000, commission: 2.0, reservationDeposit: 250000, paymentPlan: "15% down · 6y installments", collectionPercent: 12, commissionLocked: true, homesAdvanceAvailable: true,  revenueRecognised: true,  attachments: [{ id:'ATT-026', name:'SPA_OpenSky_F305.pdf', size:'1.3 MB', uploadedAt:'2026-02-05' }, { id:'ATT-027', name:'Commission_Release_TM.pdf', size:'180 KB', uploadedAt:'2026-02-15' }], status: "Closed", created: "2026-01-12" },
  { id: "D-606", type: "OffPlan", lead: "Karim Mostafa",   leadName: "Karim Mostafa",   owner: "Ahmed Hassan",  team: "Alpha", project: "Mountain View iCity",  developer: "Mountain View",    propertyId: "LST-007", stage: "Standard Collection (10%)",     value: 12545000, commission: 2.2, reservationDeposit: 280000, paymentPlan: "10% down · 7y installments", collectionPercent: 14, commissionLocked: true, homesAdvanceAvailable: true,  revenueRecognised: true,  attachments: [{ id:'ATT-028', name:'SPA_MV_DX44.pdf', size:'1.2 MB', uploadedAt:'2026-01-20' }, { id:'ATT-029', name:'Commission_Release_MV.pdf', size:'180 KB', uploadedAt:'2026-01-22' }], status: "Closed",      created: "2025-12-15" },
  { id: "D-607", type: "OffPlan", lead: "Mahmoud Farid",   leadName: "Mahmoud Farid",   owner: "Ahmed Hassan",  team: "Alpha", project: "Palm Parks",           developer: "Palm Hills",       propertyId: null,      stage: "Contract Signed",               value: 17250000, commission: 2.0, reservationDeposit: 350000, paymentPlan: "20% down · 5y installments", collectionPercent: 6,  commissionLocked: true, homesAdvanceAvailable: true,  revenueRecognised: false, attachments: [{ id:'ATT-030', name:'SPA_PalmParks_TW15.pdf', size:'1.3 MB', uploadedAt:'2026-04-26' }], status: "Active",      created: "2026-04-22" },
  { id: "D-608", type: "OffPlan", lead: "Sherif Adel",     leadName: "Sherif Adel",     owner: "Ahmed Hassan",  team: "Alpha", project: "Zayed Heights",        developer: "Sodic",            propertyId: null,      stage: "Contract Signed",               value: 6750000,  commission: 1.5, reservationDeposit: 140000, paymentPlan: "15% down · 6y installments", collectionPercent: 3,  commissionLocked: true, homesAdvanceAvailable: false, revenueRecognised: false, attachments: [{ id:'ATT-031', name:'SPA_ZH_A105.pdf', size:'1.1 MB', uploadedAt:'2026-04-08' }], status: "Active",      created: "2026-04-05" },
  { id: "D-609", type: "OffPlan", lead: "Iman Saber",      leadName: "Iman Saber",      owner: "Fatma Ibrahim", team: "Alpha", project: "Cairo Gate",           developer: "Emaar",            propertyId: null,      stage: "Contract Signed",               value: 13950000, commission: 2.0, reservationDeposit: 280000, paymentPlan: "15% down · 6y installments", collectionPercent: 4,  commissionLocked: true, homesAdvanceAvailable: false, revenueRecognised: false, attachments: [{ id:'ATT-032', name:'SPA_CairoGate_A308.pdf', size:'1.2 MB', uploadedAt:'2026-04-22' }], status: "Active",      created: "2026-04-20" },
  { id: "D-610", type: "OffPlan", lead: "Hossam Talaat",   leadName: "Hossam Talaat",   owner: "Omar Sherif",   team: "Beta",  project: "Allegria",             developer: "Sodic",            propertyId: null,      stage: "Standard Collection (10%)",     value: 5400000,  commission: 2.0, reservationDeposit: 110000, paymentPlan: "15% down · 6y installments", collectionPercent: 12, commissionLocked: true,  homesAdvanceAvailable: true,  revenueRecognised: true,  attachments: [{ id:'ATT-033', name:'Contract_Allegria_A505.pdf', size:'1.0 MB', uploadedAt:'2026-02-10' }], status: "Closed",      created: "2026-01-25" },
  { id: "D-611", type: "OffPlan", lead: "Walid Salah",     leadName: "Walid Salah",     owner: "Mohamed Ali",   team: "Beta",  project: "Palm Hills New Cairo", developer: "Palm Hills",       propertyId: "LST-001", stage: "Reservation",                   value: 9000000,  commission: 2.2, reservationDeposit: 180000, paymentPlan: "10% down · 7y installments", collectionPercent: 0,  commissionLocked: false, homesAdvanceAvailable: false, revenueRecognised: false, attachments: [{ id:'ATT-034', name:'Reservation_PH_VA305.pdf', size:'320 KB', uploadedAt:'2026-05-06' }], status: "Active",      created: "2026-05-05" },
];
...
export const AUDIT_LOGS = [
  ...
  // ─── Candidate pipeline activity — per-candidate audit trail (May 2026) ───
  { id: "AUD-CA001", action: "Candidate Added", actor: "HR Recruiter", target: "CAN-001", module: "Recruitment", timestamp: "2024-01-10 09:15:00", detail: "Application received for Senior Sales Agent (JOB-001) · photo + CV attached" },
  { id: "AUD-CA002", action: "Candidate Stage Change", actor: "HR Recruiter", target: "CAN-001", module: "Recruitment", timestamp: "2024-01-12 11:30:00", detail: "Applied → Screening (HR direct)" },
  { id: "AUD-CA003", action: "Interview Scheduled", actor: "HR Recruiter", target: "CAN-001", module: "Recruitment", timestamp: "2024-01-15 14:00:00", detail: "with Sales Manager" },
  { id: "AUD-CA004", action: "Candidate Added", actor: "HR Recruiter", target: "CAN-002", module: "Recruitment", timestamp: "2024-01-12 09:15:00", detail: "Application received for Senior Sales Agent (JOB-001) · photo + CV attached" },
  { id: "AUD-CA005", action: "Candidate Stage Change", actor: "HR Recruiter", target: "CAN-002", module: "Recruitment", timestamp: "2024-01-14 11:30:00", detail: "Applied → Screening (HR direct)" },
  { id: "AUD-CA006", action: "Candidate Added", actor: "HR Recruiter", target: "CAN-003", module: "Recruitment", timestamp: "2024-01-06 09:15:00", detail: "Application received for Junior Sales Agent (JOB-002) · photo + CV attached" },
  { id: "AUD-CA007", action: "Candidate Stage Change", actor: "HR Recruiter", target: "CAN-003", module: "Recruitment", timestamp: "2024-01-08 11:30:00", detail: "Applied → Screening (HR direct)" },
  { id: "AUD-CA008", action: "Interview Scheduled", actor: "HR Recruiter", target: "CAN-003", module: "Recruitment", timestamp: "2024-01-11 14:00:00", detail: "with Omar Sherif" },
  { id: "AUD-CA009", action: "Offer Drafted", actor: "HR Recruiter", target: "CAN-003", module: "Recruitment", timestamp: "2024-01-15 10:45:00", detail: "Junior Sales Agent · pending Sales Director approval" },
  { id: "AUD-CA010", action: "Candidate Added", actor: "HR Recruiter", target: "CAN-004", module: "Recruitment", timestamp: "2024-01-09 09:15:00", detail: "Application received for Junior Sales Agent (JOB-002) · photo + CV attached" },
  { id: "AUD-CA011", action: "Candidate Stage Change", actor: "HR Recruiter", target: "CAN-004", module: "Recruitment", timestamp: "2024-01-11 11:30:00", detail: "Applied → Screening (HR direct)" },
  { id: "AUD-CA012", action: "Interview Scheduled", actor: "HR Recruiter", target: "CAN-004", module: "Recruitment", timestamp: "2024-01-14 14:00:00", detail: "with Sales Manager" },
  { id: "AUD-CA013", action: "Candidate Rejected", actor: "HR Recruiter", target: "CAN-004", module: "Recruitment", timestamp: "2024-01-17 16:20:00", detail: "Did not meet the role requirements" },
  { id: "AUD-CA014", action: "Candidate Added", actor: "HR Recruiter", target: "CAN-005", module: "Recruitment", timestamp: "2024-01-16 09:15:00", detail: "Application received for Senior Sales Agent (JOB-001) · photo + CV attached" },
  { id: "AUD-CA015", action: "Candidate Added", actor: "HR Recruiter", target: "CAN-006", module: "Recruitment", timestamp: "2024-01-17 09:15:00", detail: "Application received for HR Coordinator (JOB-003) · photo + CV attached" },
  { id: "AUD-CA016", action: "Candidate Added", actor: "HR Recruiter", target: "CAN-007", module: "Recruitment", timestamp: "2026-05-12 09:15:00", detail: "Application received for Senior Sales Agent (JOB-001) · photo + CV attached" },
  { id: "AUD-CA017", action: "Candidate Added", actor: "HR Recruiter", target: "CAN-008", module: "Recruitment", timestamp: "2026-05-08 09:15:00", detail: "Application received for Junior Sales Agent (JOB-002) · photo + CV attached" },
  { id: "AUD-CA018", action: "Candidate Stage Change", actor: "HR Recruiter", target: "CAN-008", module: "Recruitment", timestamp: "2026-05-10 11:30:00", detail: "Applied → Screening (HR direct)" },
  { id: "AUD-CA019", action: "Candidate Added", actor: "HR Recruiter", target: "CAN-009", module: "Recruitment", timestamp: "2026-05-10 09:15:00", detail: "Application received for Senior Sales Agent (JOB-001) · photo + CV attached" },
  { id: "AUD-CA020", action: "Candidate Stage Change", actor: "HR Recruiter", target: "CAN-009", module: "Recruitment", timestamp: "2026-05-12 11:30:00", detail: "Applied → Screening (HR direct)" },
  { id: "AUD-CA021", action: "Candidate Added", actor: "HR Recruiter", target: "CAN-010", module: "Recruitment", timestamp: "2026-04-25 09:15:00", detail: "Application received for Sales Manager (JOB-001) · photo + CV attached" },
  { id: "AUD-CA022", action: "Candidate Stage Change", actor: "HR Recruiter", target: "CAN-010", module: "Recruitment", timestamp: "2026-04-27 11:30:00", detail: "Applied → Screening (HR direct)" },
  { id: "AUD-CA023", action: "Interview Scheduled", actor: "HR Recruiter", target: "CAN-010", module: "Recruitment", timestamp: "2026-04-30 14:00:00", detail: "with Tarek Amin" },
  { id: "AUD-CA024", action: "Candidate Added", actor: "HR Recruiter", target: "CAN-011", module: "Recruitment", timestamp: "2026-04-22 09:15:00", detail: "Application received for Marketing Lead (JOB-004) · photo + CV attached" },
  { id: "AUD-CA025", action: "Candidate Stage Change", actor: "HR Recruiter", target: "CAN-011", module: "Recruitment", timestamp: "2026-04-24 11:30:00", detail: "Applied → Screening (HR direct)" },
  { id: "AUD-CA026", action: "Interview Scheduled", actor: "HR Recruiter", target: "CAN-011", module: "Recruitment", timestamp: "2026-04-27 14:00:00", detail: "with Dina Samir" },
  { id: "AUD-CA027", action: "Candidate Added", actor: "HR Recruiter", target: "CAN-012", module: "Recruitment", timestamp: "2026-04-12 09:15:00", detail: "Application received for Finance Analyst (JOB-006) · photo + CV attached" },
  { id: "AUD-CA028", action: "Candidate Stage Change", actor: "HR Recruiter", target: "CAN-012", module: "Recruitment", timestamp: "2026-04-14 11:30:00", detail: "Applied → Screening (HR direct)" },
  { id: "AUD-CA029", action: "Interview Scheduled", actor: "HR Recruiter", target: "CAN-012", module: "Recruitment", timestamp: "2026-04-17 14:00:00", detail: "with Khaled Magdy" },
  { id: "AUD-CA030", action: "Offer Drafted", actor: "HR Recruiter", target: "CAN-012", module: "Recruitment", timestamp: "2026-04-21 10:45:00", detail: "Finance Analyst · pending Sales Director approval" },
  { id: "AUD-CA031", action: "Candidate Added", actor: "HR Recruiter", target: "CAN-013", module: "Recruitment", timestamp: "2026-04-18 09:15:00", detail: "Application received for Junior Sales Agent (JOB-002) · photo + CV attached" },
  { id: "AUD-CA032", action: "Candidate Stage Change", actor: "HR Recruiter", target: "CAN-013", module: "Recruitment", timestamp: "2026-04-20 11:30:00", detail: "Applied → Screening (HR direct)" },
  { id: "AUD-CA033", action: "Interview Scheduled", actor: "HR Recruiter", target: "CAN-013", module: "Recruitment", timestamp: "2026-04-23 14:00:00", detail: "with Omar Sherif" },
  { id: "AUD-CA034", action: "Candidate Rejected", actor: "HR Recruiter", target: "CAN-013", module: "Recruitment", timestamp: "2026-04-26 16:20:00", detail: "Below minimum experience requirement (2 years)" },
  { id: "AUD-CA035", action: "Candidate Added", actor: "HR Recruiter", target: "CAN-014", module: "Recruitment", timestamp: "2026-05-15 09:15:00", detail: "Application received for HR Coordinator (JOB-003) · photo + CV attached" },
];
...
const _historyFor = (ce, splits) => {
  ...
  if (ce.status === 'Invoiced') return [created, invoiced];
  if (ce.status === 'Collected') return [created, invoiced, paid];
...
const _enrichCE = (rows) => rows.map((ce) => {
  ...
  const invoicedEntry = history.find(h => h.action === 'Invoiced');
  ...
  return {
    ...
    director: _DIR,
    history,
    invoicedAt: invoicedEntry?.at  || null,
    invoicedBy: invoicedEntry?.actor || null,
    ...
    referenceNo: ce.referenceNo || ((ce.status === 'Invoiced' || ce.status === 'Collected') ? `CLM-2026-${String(ce.id).replace(/\D/g,'').padStart(4,'0')}` : null),
    invoiceNo: ce.invoiceNo || ((ce.status === 'Invoiced' || ce.status === 'Collected') ? `INV-2026-${String(ce.id).replace(/\D/g,'').padStart(4,'0')}` : null),
  };
});

// Commission Engine rows. Each commission row now carries explicit deal
// context so the engine surface can show the linked Deal ID + Unit code +
// Developer alongside the agent + pool. `dealId` points at a DEALS row
// where one exists (most do — closed/active deals that generated this
// commission); `unit` is the human-readable unit reference (e.g. TH-B304),
// `project` is the development, and `developer` is the master-data brand.
// The legacy `deal` field is preserved as a display label (it carries the
// unit code in the old format) so toasts/search continue to work.
export const COMM_ENGINE = _enrichCE([
  { id:'CE-01', deal:'PH-BAD-A101',  dealId:'D-601', developer:'Palm Hills',     project:'Badya',                  unit:'A101',   agent:'Ahmed Hassan',  pool:135000, status:'Invoiced', createdAt:'2026-04-12' },
  ...
  { id:'CE-04', deal:'ORA-ZED-D102', dealId:'D-501', developer:'Ora',            project:'ZED East',               unit:'D102',   agent:'Sara Nabil',    pool:153000, status:'Invoiced', createdAt:'2026-04-30' },
  ...
  { id:'CE-07', deal:'SD-EST-G110',  dealId:null,    developer:'Sodic',          project:'Eastown Residences',     unit:'G110',   agent:'Mohamed Ali',   pool:276000, status:'Invoiced', createdAt:'2026-05-02' },
  // ─── Expansion seed (May 2026) ───
  { id:'CE-08', deal:'PH-NC-V101',   dealId:'D-504', developer:'Palm Hills',     project:'Palm Hills New Cairo',   unit:'V101',   agent:'Fatma Ibrahim', pool:396000, status:'Invoiced', createdAt:'2026-04-05' },
  ...
  { id:'CE-10', deal:'MR-CH-12',     dealId:'D-516', developer:'Emaar',          project:'Marassi',                unit:'CH-12',  agent:'Fatma Ibrahim', pool:510000, status:'Invoiced', createdAt:'2026-04-18' },
  ...
  { id:'CE-16', deal:'ET-A-301',     dealId:'D-523', developer:'Sodic',          project:'Eastown Residences',     unit:'A-301',  agent:'Fatma Ibrahim', pool:417450, status:'Invoiced', createdAt:'2026-04-22' },
  { id:'CE-17', deal:'PP-TW-15',     dealId:'D-607', developer:'Palm Hills',     project:'Palm Parks',             unit:'TW-15',  agent:'Ahmed Hassan',  pool:345000, status:'Invoiced', createdAt:'2026-04-28' },
  { id:'CE-18', deal:'CFC-A-410',    dealId:'D-521', developer:'Al-Futtaim',     project:'Cairo Festival City',    unit:'A-410',  agent:'Omar Sherif',   pool:234000, status:'Invoiced', createdAt:'2026-05-04' },
  ...
  { id:'CE-20', deal:'ZH-A-105',     dealId:'D-608', developer:'Sodic',          project:'Zayed Heights',          unit:'A-105',  agent:'Ahmed Hassan',  pool:101250, status:'Invoiced', createdAt:'2026-04-10' },
  ...
  { id:'CE-22', deal:'CG-A-308',     dealId:'D-609', developer:'Emaar',          project:'Cairo Gate',             unit:'A-308',  agent:'Fatma Ibrahim', pool:279000, status:'Invoiced', createdAt:'2026-04-24' },
  ...
  { id:'CE-24', deal:'HP-A-220',     dealId:'D-515', developer:'Hyde Park',      project:'Hyde Park',              unit:'A-220',  agent:'Ahmed Hassan',  pool:294000, status:'Invoiced', createdAt:'2026-05-06' },
...
// (see DEAL_STAGES_OFFPLAN above): commission locks at "Contract Signed";
// revenue recognises at "Standard Collection (10%)". The legacy Resale
// pipeline was retired in May 2026 — see notes near DEAL_STAGES_OFFPLAN.
