...
import {
  ...
  AGENT_NOTIFICATIONS, AGENT_DOCS, SUPPORT_TICKETS, COLD_CALLS, COLD_CALL_BATCHES,
  ANNOUNCEMENTS, TARGETS, MARKETING_AGENCIES,
  OFFERS, SALARY_BANDS, APPLICATION_STAGE_META,
  TOURS, LISTING_SHARES, BUYER_PREFERENCES, SOURCE_HISTORY, DUPLICATE_CANDIDATES, ASSIGNMENT_LOG, LISTINGS,
  INTRO_CALLS,
...
const initialState = {
  ...
  coldCallBatches: COLD_CALL_BATCHES,
  announcements: ANNOUNCEMENTS,
  targets: TARGETS,
  marketingAgencies: MARKETING_AGENCIES,
  offers: OFFERS,
  salaryBands: SALARY_BANDS,
  calendarSync: { lastSyncedAt: null, status: 'not_connected' },
  supportTickets: SUPPORT_TICKETS,
  tours: TOURS,
  listingShares: LISTING_SHARES,
  introCalls: INTRO_CALLS,
